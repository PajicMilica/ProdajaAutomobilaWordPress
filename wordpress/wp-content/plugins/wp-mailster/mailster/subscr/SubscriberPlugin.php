...
class MstSubscriberPlugin
{
                    ...
                    <p><?php
                        if($allLists){  ?>
                            ...
                            if(!is_null($list)){ ?>
                                ...
                                <label class="<?php echo $cssPrefix; ?>listLabel" for="<?php echo MstConsts::SUBSCR_ID_FIELD; ?>"><span><?php echo $listLabel; ?></span></label>
                                <span class="<?php echo $cssPrefix; ?>listName <?php echo $cssPrefix; ?>errorMessage <?php echo $cssPrefix; ?>message"><?php echo __('Unknown list', 'wp-mailster'); ?></span><?php
                                $errors++;
                            }
                        } ?>
                    </p><?php
	...
	public function getUnsubscriberHtml($res, $formIdentifier, $showHeaderTitle = true)
	{
		...
		$unsubscribeIncative = __( 'Unsubscribing currently not possible', 'wp-mailster' );
                ...
                <form action="" method="post" id="unsubscr<?php echo $formIdentifier; ?>" class="wpmst-unsubscribe-form"  data-wpmstformid="<?php echo $formIdentifier; ?>">
                    ...
                    if($allLists){
                        ...
                        if($list){ ?>
                            ...
                            <p>
                            <label class="<?php echo $cssPrefix; ?>listLabel" for="<?php echo MstConsts::SUBSCR_ID_FIELD; ?>"><span><?php echo $listLabel; ?></span></label>
                            <span class="<?php echo $cssPrefix; ?>listName <?php echo $cssPrefix; ?>errorMessage <?php echo $cssPrefix; ?>message"><?php echo __('Unknown list', 'wp-mailster'); ?></span><input type="hidden" name="<?php echo MstConsts::SUBSCR_ID_FIELD; ?>" value="" />
                            </p><?php
                            $errors++;
                        }
                    }
