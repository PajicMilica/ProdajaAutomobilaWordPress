	...
	<div class="wrap">
		...
		<div class="statistics">
			...
			<div class="statistic">
				...
				?>
				<h3><?php _e("Plugin Activity", 'wp-mailster'); ?> <a href="#" id="resetTimer"><?php _e("Reset", 'wp-mailster'); ?></a> </h3>
				<ul>
				...
				?>
					<li>
						<div class="listTitle">
							...
							<h4>
								<a href="#" class="activeToggler" id="activeToggler<?php echo $list->id; ?>" title="<?php echo ($list->active == '1' ? _e("Currently active, click to deactivate", 'wp-mailster') : _e("Curretnly inactive, click to activate", 'wp-mailster')); ?>">
        ...
        <div class="statistic product-info clearfix">
            <div class="statistic-left">
                <br/>
                <?php $showSystemDiagnosis = '?page=wpmst_mailster_intro&subpage=diagnosis&nocochk=1'; ?>
