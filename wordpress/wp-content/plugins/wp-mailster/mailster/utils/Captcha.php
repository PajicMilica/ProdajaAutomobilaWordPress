    ...
    function getHtml($cError=null, $cssPrefix='', $targetHtmlId = null){
        ...
        switch($this->cType){
            ...
            case MstConsts::CAPTCHA_ID_RECAPTCHA: // NO LONGER SUPPORTED !!!
                $this->html = __( 'reCAPTCHA version no longer supported', 'wp-mailster' );
                $this->error = true;
                break;
            ...
            case MstConsts::CAPTCHA_ID_RECAPTCHA_V2:
                ...
                if((!is_null($pubK)) && (strlen($pubK)>5)
                    ...
                    $this->html = __( 'Please provide reCAPTCHA API keys in the configuration settings of Mailster', 'wp-mailster' );
                    $this->error = true;
                }
                break;
