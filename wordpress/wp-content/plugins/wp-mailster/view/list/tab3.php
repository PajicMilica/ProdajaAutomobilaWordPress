...
<table class="form-table">
	<tbody>
		...
		$this->mst_display_password_field( __("Password", 'wp-mailster'), 'mail_out_pw', $options->mail_out_pw, null, false, false, __("Email Password. Allowed special characters: @!$%&/~*#.:,_", 'wp-mailster') );
