...
function success() {
	...
	<div class="contentpane">
		<div id="mailsterContainer">
			<div id="mailsterUnsubscriber">
				<div id="mailsterUnsubscriberDescription" class="success">Unsubscription successful</div>
			</div>
		</div>
	</div>
<?php
...
function fail($error_message) {
	...
	<div class="contentpane">
		<div id="mailsterContainer">
			<div id="mailsterUnsubscriber">
				<div id="mailsterUnsubscriberDescription" class="failure"><?php echo $error_message; ?></div>
			</div>
		</div>
	</div>
	<?php
