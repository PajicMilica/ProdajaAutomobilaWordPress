...
{		
	...
	public static function getEventExtraInformation(&$entry){
		...
		if($entry->recips && $entry->recips != null){
			...
			$entry->recips->toStr = $mailUtils->getRecipInfoStr($entry->recips->to);
			$entry->recips->ccStr = $mailUtils->getRecipInfoStr($entry->recips->cc);
			$entry->recips->bccStr = $mailUtils->getRecipInfoStr($entry->recips->bcc);
		}
	}
