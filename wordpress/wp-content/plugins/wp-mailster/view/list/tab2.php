...
<table class="form-table">
	...
	$this->mst_display_password_field( __("Password", 'wp-mailster'), 'mail_in_pw', $options->mail_in_pw, null, false, false, __("Email Password. Allowed special characters: @!$%&/~*#.:,_", 'wp-mailster') );
	?>
	<tr>
		<td colspan="2">
