            ...
            events: function() {
                ...
                if (self.options.search && self.options.search.$left) {
                    self.options.search.$left.on('keyup', function(e) {
                        if (self.callbacks.fireSearch(e.target.value)) {
                            var $toShow = self.$left.find('option:search("' + e.target.value + '")').mShow();
                            var $toHide = self.$left.find('option:not(:search("' + e.target.value + '"))').mHide();
                ...
                if (self.options.search && self.options.search.$right) {
                    self.options.search.$right.on('keyup', function(e) {
                        if (self.callbacks.fireSearch(e.target.value)) {
                            var $toShow = self.$right.find('option:search("' + e.target.value + '")').mShow();
                            var $toHide = self.$right.find('option:not(:search("' + e.target.value + '"))').mHide();
